...
class LocationFood : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_location_food)
//
//
//        val btndeatils = findViewById<Button>(R.id.btn details)
//
//        btndeatils.setOnClickListener {
//            val intent = Intent(applicationContext,ShowFoodOffer::class.java)
    ...
    private fun getlocation() {
        ...
        task.addOnSuccessListener { location ->
            if (location != null) {
                ...
                val geocoder = Geocoder(this@LocationFood, Locale.getDefault())

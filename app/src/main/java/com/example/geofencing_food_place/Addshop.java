    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        binding.btninsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String place1 = binding.edaddress.getText().toString().trim();
                String address = binding.edmobile.getText().toString().trim();
                String place2 = binding.editem1.getText().toString().trim();
                String des2 = binding.edprice1.getText().toString().trim();
                String place3 = binding.editem2.getText().toString().trim();

...
class Placedetails : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtname.text = "Place name: "+name
        txtaddress.text = "Address: " +address
        txtmobile.text = "History: "+mobileno
        txtitem1.text = "Time : " + item1
        txtprice1.text = "Landmark: "+price1
        ...
        btn.setOnClickListener {
            try {
                val uri = Uri.parse("https://www.google.co.in/maps/dir/"+"/"+ price1)
